return {
    ...
    init = function()
        ...
        vim.api.nvim_create_user_command("MathNew", function(cmd)
            ...
            local filepath = (dir == ".") and (math_dir .. "/" .. filename) or
                (math_dir .. "/" .. dir .. "/" .. filename)
            ...
            if is_new then
                ...
                local template = {
                    ...
                    "\\usepackage{amsmath,amssymb,todonotes,minted}",
                    ...
                    "\tfonttitle=\\bfseries,",
                    "\ttitle=Question \\thetcbcounter\\ifstrempty{#1}{}{: #1},",
                    "\tenhanced,",
                    "\tattach boxed title to top left={xshift=2mm, yshift=-2mm},",
                    "\tboxed title style={colback=blue!75!black}",
                    "}",
                    "\\title{" .. string.upper(title) .. "}",
                    "\\author{LWHXE}",
                    "\\date{\\today}",
                    "",
                    "\\begin{document}",
